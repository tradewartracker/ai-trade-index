...
This paper documents facts about international trade in AI-related products. I develop a large language model (LLM) classification tool that maps HS10 codes in U.S. trade data to inputs used in the construction and operation of AI infrastructure. Using this classification, I find that U.S. imports of AI-related products rose by \highAiPctChange{} percent since 2023, non-AI-related products declined by \lowAiPctChange{} percent with the divergence occurring early 2024. Since the start of the 2025 trade war, AI-related products face lower tariffs, \tariffHighTwentyFive{} percent versus \tariffLowTwentyFive{} percent for non-AI-related products. An important reason for why 2025 aggregate imports did not decline is because AI-related trade more than offset a decline in non-AI trade.
